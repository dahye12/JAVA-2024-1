 ...
 * 
 * Calculator 클래스 
 * main 메소드 : Calculator_class로 부터 객체를 생성하고, 두 정수를 입력받아 합과 차를 출력합니다. 
 * [출력결과]
 * 첫 번째 정수 입력 : 3
 * 두 번째 정수 입력 : 3
 * 두 정수의 합계 : 8
...
public class Calculator {
	...
	public static void main(String[] args) {
		...
		System.out.println("두 번째 정수 합 : " + calc.add(num1, num2));
		System.out.println("두 번째 정수 차 : " + calc.subtract(num1, num2));
		...
		System.out.println("두 번째 실수 합 : " + calc.add(num3, num4));
		System.out.println("두 번째 실수 차 : " + calc.subtract(num3, num4));
