 ...
 * 설명 : 두 개의 정수를 입력받아 두수 사이의 모든 합과 짝수의 합, 홀수의 합을 출력하시오.
 ...
 * 		각 메소드에 접근하여 합계를 계산하려면 반드시 객체르 생성해야 한다. 
 * 		객체를 통해서 각 메소드에 접근 할 수 있다. 
 * 
 *  [알고리즘]
 *  	1. 클래스 선언 = sum
 *  		1-1. 멤버변수 sum 선언.
 *  		1-2. 전체 합계 계산하는 메소드 선언. - 정수형으로 선언 
 *  			1-2-1. 두 개의 매개변수를 전달받아 전체 합계 계산.
 *  			1-2-2. 합계를 돌려준다. - 정수값  
 *  
 *  		1-3. 짝수의 합계 계산하는 메소드 선언. - 정수형
 *  			1-3-1. 두 개의 매개변수를 전달받아 전체 짝수 계산.
 *  			1-3-2. 합계를 돌려준다. - 정수값  
 *  
 *  		1-4. 홀수의 합계 계산하는 메소드 선언. - 정수형
 *  			1-4-1. 두 개의 매개변수를 전달받아 전체 홀수 계산.
 *  			1-4-2. 합계를 돌려준다. - 정수값  
 *  	2. 메인 메소드가 있는 클래스 선언.
 *  		2-1. 두 개의 정수를 입력 받는다. 
...
class Sum{
	// 멤버변수 선언. - 속성
	public int sum; //멤버변수는 초기화 하지않아도 된다. 
	// 전체 합계 계산하는 메소드 
	public int allSum(int num1, int num2) {
		...
		return sum; // 메소드를 호출한 곳으로 값을 돌려줌. // sum 색깔로 구분해  
	}
...
public class SumTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println(num1 + "부터" + num2 + "까지의 합 : " + s.oddSum(num1,num2));
